...
export default async function Hero() {
  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={`wrapper ${styles.hero__inner}`}>
        <div className={styles.hero__content}>
          <span className={styles.hero__label}>
            Agendamento sem complicação
          </span>

          <h1 className={styles.hero__title}>Seu corte perfeito.</h1>
          ...
          <div className={styles.hero__actions}>
            <a href="/agendar" className={styles.hero__cta}>
              Começar agora
              <svg
                width="16"
                height="16"
            ...
            <a
              ...
              className={styles.hero__whatsapp}
            >
              <svg
                width="20"
                height="20"
              ...
              <span className={styles["hero__whatsapp-number"]}>
                {WHATSAPP_NUMBER}
              </span>
            </a>
          </div>
      ...
      <div className={styles.hero__scroll}>
        <span className={styles["hero__scroll-text"]}>Role para explorar</span>
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
