                ...
                <form className="form" onSubmit={onSubmit} noValidate>
                    <label className="field">
                        ...
                        <input
                            ...
                            {...nameField}
                        />
                        {errors.name && <small className="formError">{errors.name.message}</small>}
                    </label>
                    ...
                    <label className="field">
                        ...
                        {errors.confirmPassword && (
                            <small className="formError">{errors.confirmPassword.message}</small>
                        )}
                    </label>

                    {errors.root && <small className="formError">{errors.root.message}</small>}
